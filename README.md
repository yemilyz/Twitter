...
There were a lot of problems with sending intents back and forth, as well as being unable to see the favorites of retweets. Implemementing the buttons and each on click listener was also a challenge.
...
# Project 4 - *TweetyTwit*

**TweetyTwit** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] User can **view the tweets from their home timeline**
  ...
  * [x] User is displayed the [relative timestamp](https://gist.github.com/nesquena/f786232f5ef72f6e10a7) for each tweet "8m", "7h"
* [x] User can **compose and post a new tweet**
  * [x] User can click a "Compose" icon, a floating action button
...
Difficulty changing and breaking activities to use fragments instead. 
Modal overlay still unfunctioning. 
