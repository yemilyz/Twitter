...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "HitVGG3mIyLXAsZD0UDppr658";       // Change this
	public static final String REST_CONSUMER_SECRET = "moZFI4YN41vNIFKXtrMDGqS0XAQFIdsftzKoCvjg5mgH8Ztf2v"; // Change this
	...
	public void postNotRetweet(long id, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/unretweet.json");
		RequestParams params = new RequestParams();
		params.put("id", id);
		client.post(apiUrl, params, handler);
	}
	public void getHomeTimelinePage(long maxId, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", 25);
    ...
    public void getMentionsTimelinePage(long maxId, AsyncHttpResponseHandler handler){
        String apiUrl = getApiUrl("statuses/mentions_timeline.json");
        // Can specify query string params directly or through RequestParams.
        RequestParams params = new RequestParams();
        params.put("count", 25);
